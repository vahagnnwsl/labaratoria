            ...
            @else
                <div class="card-body w-100">
                    <form method="POST" action="{{route('patient.store')}}" id="form">
                        ...
                        <fieldset>
                            <div class="mb-3">
                                <label for="full_name" class="form-label">Имя Фамилия (латиницей, как в паспорте) / Full Name *</label>
                            ...
                            <div class="mb-3">
                                <label for="whats_app" class="form-label">Номер WhatsApp (любой формат) / WhatsApp Number *</label>
                            ...
                            <div class="mb-3">
                                <label for="birth_day" class="form-label">Дата рождения / Date of Birth *</label>
                            ...
                            <div class="mb-3">
                                <label for="sex" class="form-label">Пол / Gender *</label>
                           ...
                           <strong>{{ $message }}</strong>
                            ...
                            <div class="mb-3">
                                <label for="passport_number" class="form-label">Номер паспорта / Passport Number *</label>
                            ...
                            <div class="mb-3">
                                <label for="flight" class="form-label">Номер рейса (например SU 107) / Flight Number (e.g. SU 107)</label>
